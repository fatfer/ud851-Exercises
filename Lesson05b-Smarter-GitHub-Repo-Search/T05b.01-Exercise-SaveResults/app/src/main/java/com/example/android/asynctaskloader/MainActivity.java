...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            if(savedInstanceState.containsKey(QUERY_URL)){
                mUrlDisplayTextView.setText(savedInstanceState
                        .getString(QUERY_URL).toString());
            }
            if(savedInstanceState.containsKey(SEARCH_JSON)){
                mSearchResultsTextView.setText(savedInstanceState
                        .getString(SEARCH_JSON).toString());
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_JSON, urlTextView);
